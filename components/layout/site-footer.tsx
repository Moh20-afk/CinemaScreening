export function SiteFooter() {
  return (
    <footer className="mx-auto w-full max-w-6xl px-3 pb-28 pt-8 text-center text-[11px] leading-relaxed text-muted-foreground sm:px-4 md:px-6 lg:pb-10">
      <p>
        Live showtimes from Vue, Everyman, HOME Manchester, The Light Stockport, Northern
        Light Stretford and Stockport Plaza. Cineworld and ODEON times open on their websites.
      </p>
      <p className="mt-2">
